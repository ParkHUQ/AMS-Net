...
def parse_directory(path,
    ...
    for i, frame_dir in enumerate(frame_dirs):
        ...
        #print(dir_name, total_num)
        frame_dict[dir_name] = (dir_name, total_num[0], num_x)
...
def parse_diving48_splits():
    ...
    train_file = '/home/dataset/video/RGB/Diving48/diving48v2/Diving48_V2_train.json'
    test_file = '/home/dataset/video/RGB/Diving48/diving48v2/Diving48_V2_test.json'
    ...
    # class_index_file = '/home/dataset/video/RGB/Diving48/diving48v1/Diving48_vocab.json'
    # class_list = json.load(open(class_index_file))
