...
ann_file_train = 'data/finegym/gym288_train_frame_v1.txt'
ann_file_val = 'data/finegym/gym288_val_frame.txt'
ann_file_test = 'data/finegym/gym288_val_frame.txt'

model=dict(
    backbone=dict(pretrained=None),
    neck=dict(temporal_modulation_cfg=dict(downsample_scales=(16, 16)),
              aux_head_cfg=dict(out_channels=288, loss_weight=0.5)),
    cls_head=dict(num_classes=288))
...
# runtime settings
work_dir = './work_dirs/ams_slowonlyR50_pretrained_16x4x1_110e_gym288_rgb'  
load_from = '/home/zhangli/Project/AMG-slow-v1.a.2_cp/models/idg5_lr1e-2_step75100_epoch_104.pth'   